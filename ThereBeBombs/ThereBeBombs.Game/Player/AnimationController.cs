...
namespace ThereBeBombs.Player
{
    public class AnimationController : SyncScript, IBlendTreeBuilder
    {
        ...
        private void UpdateWalking()
        {
            ...
            Xenko.Games.GameTime time = Game.DrawTime;
            ...
            TimeSpan currentTicks = TimeSpan.FromTicks((long)(currentTime * blendedMaxDuration));
        ...
        {
            int speedFactor = 1;
            TimeSpan currentTicks = TimeSpan.FromTicks((long)(currentTime * AnimationPunch.Duration.Ticks));
